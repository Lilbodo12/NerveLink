 ...
 * This file demonstrates how to integrate Nervelink with a web frontend
 */

// For React/Vue/Angular applications
export class NervelinkClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NervelinkClient(provider, contractAddress);
